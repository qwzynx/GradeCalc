  ...
  return (
     <GlassCard className="form-card relative z-10 w-full border-secondary shadow-[0_0_30px_rgba(242,166,90,0.15)]">
       <div className="flex justify-between items-center border-b border-prHighlight pb-2 mb-4">
         ...
         <button onClick={onCancel} className="text-alt-color hover:text-white transition-colors">
       ...
       <form onSubmit={onSubmit} className="flex flex-col gap-4">
         ...
         <div className="flex gap-4">
           ...
           <div className="flex-1">
             ...
             <select required name="category" defaultValue={course.category || ""} className="w-full bg-primary/50 border border-prHighlight rounded p-2 text-sm text-secondary focus:border-secondary transition-all appearance-none cursor-pointer">
         ...
         <div className="flex gap-2 mt-2">
           ...
           <button type="button" onClick={onDelete} className="px-3 border border-red-500/50 bg-red-900/20 text-red-500 hover:bg-red-500 hover:text-white transition-all rounded shadow-[0_0_15px_rgba(239,68,68,0.2)]">
