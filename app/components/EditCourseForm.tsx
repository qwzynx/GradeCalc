       ...
       <div className="flex justify-between items-center border-b border-black/10 pb-2 mb-4">
        ...
        <form onSubmit={onSubmit} className="flex flex-col gap-4">
         ...
         <div className="flex gap-2 mt-2">
           ...
           <button type="button" onClick={onDelete} className="px-4 min-w-[44px] min-h-[44px] flex items-center justify-center border border-red-500 bg-white text-red-500 hover:bg-red-50 hover:text-red-600 transition-all rounded shadow-sm">
