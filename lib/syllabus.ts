...
export interface ParsedSyllabus {
  course: ParsedSyllabusCourse;
  assignments: ParsedSyllabusAssignment[];
}

export const SYLLABUS_PROMPT = `You are a university syllabus parser. Analyze this document and extract the course information and ALL graded components.
...
export async function parseSyllabusDocument(base64: string, mimeType: string): Promise<ParsedSyllabus> {
